...
<template>
    <div
        class="bg-white/95 border border-sky-100 rounded-3xl p-6 shadow-xl space-y-6 text-slate-800 backdrop-blur-md relative overflow-hidden"
    >
        ...
        <div class="space-y-4">
            ...
            <div>
                <label
                    class="block text-[10px] uppercase font-bold text-slate-500 mb-2 tracking-wide"
                    >Pilih Tampilan Sisi:</label
                >
                <div
                    class="grid grid-cols-2 gap-1 bg-slate-50 p-1 rounded-xl border border-sky-100"
                >
                    <button
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2.5 items-center">
                    ...
                    <div
                        ...
                        :class="{
                            'ring-2 ring-sky-500 ring-offset-2 ring-offset-white scale-105 shadow-[0_0_15px_rgba(14,165,233,0.35)] border-solid border-sky-500/20':
        ...
        <div class="space-y-4">
            <div class="flex justify-between items-center">
                ...
                >
                    ...
                    <span>{{
                        isTextSelected ? "Edit Teks Aktif" : "Tambahkan Teks"
                    }}</span>
                </h3>
                <span
                    v-if="isTextSelected"
            ...
            >
                ...
                <div class="grid grid-cols-3 gap-2">
                    ...
                    >
                        ...
                        >
                            <span class="font-black text-sky-300 tracking-wider"
                                >KOMPRES</span
                            >
        ...
        <div
            v-if="selectedObject"
            class="space-y-3.5 p-4.5 bg-sky-50/70 border border-sky-200/50 rounded-2xl transition-all duration-300 relative overflow-hidden shadow-sm"
        >
            <!-- Glow strip -->
            <div
                class="absolute left-0 top-0 bottom-0 w-[2px] bg-gradient-to-b from-sky-500 to-indigo-500"
            ></div>

            <h4
                class="text-[10px] font-black uppercase tracking-widest text-sky-850 pl-1"
            >
            ...
            <div class="grid grid-cols-2 gap-3.5">
                ...
                >
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <span
                            class="text-[8px] text-slate-500 font-medium mt-0.5"
                            >Desain DTF/DTG (PNG)</span
                        >
                    </div>
                </button>
                <button
                ...
                >
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <span class="text-[8px] text-sky-100 font-medium mt-0.5"
                            >Preview Pelanggan (JPG)</span
                        >
                    </div>
                </button>
            </div>

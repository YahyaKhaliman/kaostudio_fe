...
import preset1Img from "../assets/presets/1.png";
        ...
        <div class="space-y-3">
            ...
            >
                ...
                >
                    <div class="flex items-center gap-3">
                        <div
                            class="p-2 rounded-xl bg-sky-500/15 text-sky-600 dark:text-sky-400 scale-110"
                        >
                            ...
                            >
                                {{
                                    store.jerseyPatternUrl
                                        ? "Motif Kustom Aktif"
                                        : "Unggah atau Pilih Motif Preset"
                                }}
                            </span>
                        </div>
                    </div>
                ...
                <div v-show="isJerseyMotifOpen" class="p-4 space-y-4">
                    ...
                    <div>
                        <label
                            class="text-[10px] font-extrabold text-slate-400 dark:text-slate-500 uppercase tracking-wider block mb-2"
                        >
                            Unggah Motif Kustom
                        </label>
                        <div class="flex gap-2 items-center">
                            <label
                                class="flex-1 border-2 border-dashed border-sky-200 dark:border-slate-750 hover:border-sky-400 rounded-xl p-3 flex items-center justify-center gap-2 cursor-pointer bg-slate-50/50 dark:bg-slate-950/30 transition-all text-xs font-bold text-sky-600 dark:text-sky-400"
                            >
                                ...
                                <input
                                    ...
                                    accept="image/*"
                                    class="hidden"
                                    @change="handleJerseyPatternUpload"
                                />
                            </label>
                            <button
                                v-if="store.jerseyPatternUrl"
                                @click="
                                    store.jerseyPatternUrl = null;
                                    store.saveToLocalStorage();
                                "
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            <button
                                ...
                                :key="preset.name"
                                @click="
                                    store.jerseyPatternUrl = preset.url;
                                    store.saveToLocalStorage();
                                "
                                type="button"
                            ...
                            >
                                ...
                                />
                                <span
                                    class="absolute bottom-0 inset-x-0 bg-slate-900/80 text-[8px] font-bold text-white text-center py-0.5 truncate px-0.5"
                                >
                                    {{ preset.name }}
                                </span>
                            </button>
                    ...
                    >
                        ...
                        <div class="grid grid-cols-2 gap-3 pt-2">
                            <div>
                                <label
                                    class="text-[9px] font-bold text-slate-500 block mb-1"
                                    >Mode Tiling</label
                                >
                                <button
                                    @click="
                                ...
                                >
                                    {{
                                        store.jerseyPatternRepeat === "repeat"
                                            ? "Pengulangan"
                                            : "Tunggal"
                                    }}
                                </button>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    />
                                    <span
                                        class="text-[10px] font-mono font-bold text-slate-600 dark:text-slate-400"
                                    >
                        ...
                        <div class="flex items-center justify-between">
                            <span
                                class="text-[10px] font-extrabold text-slate-400 dark:text-slate-500 uppercase tracking-wider"
                            >
                                Posisi & Ukuran Motif
                            </span>
                            <button
                                @click="
                                    store.resetJerseyPatternTransform();
                                    store.saveToLocalStorage();
                                "
                        ...
                        <div class="space-y-1">
                            <div
                                class="flex justify-between text-[10px] font-bold text-slate-600 dark:text-slate-400"
                            >
                                <span>Skala / Ukuran Motif</span>
                                <span
                                    class="font-mono text-sky-600 dark:text-sky-400 font-bold"
                                    >{{
                                        store.jerseyPatternScale.toFixed(2)
                                    }}x</span
                                >
                            </div>
                            <input
                        ...
                        <div class="space-y-1">
                            ...
                            >
                                ...
                                <span
                                    class="font-mono text-sky-600 dark:text-sky-400 font-bold"
                                    >{{ store.jerseyPatternRotation }}°</span
                                >
                            </div>
                            <input
                                type="range"
                        ...
                        <div class="space-y-1">
                            ...
                            >
                                ...
                                <span
                                    class="font-mono text-sky-600 dark:text-sky-400 font-bold"
                                    >{{ store.jerseyPatternOffsetX }} px</span
                                >
                            </div>
                            <input
                                type="range"
                        ...
                        <div class="space-y-1">
                            ...
                            >
                                ...
                                <span
                                    class="font-mono text-sky-600 dark:text-sky-400 font-bold"
                                    >{{ store.jerseyPatternOffsetY }} px</span
                                >
                            </div>
                            <input
                                type="range"
